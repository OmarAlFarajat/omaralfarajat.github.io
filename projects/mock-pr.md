...
<img src="../images/mino/test_gbmap.png"> 
...
After both tile and resource graphs are created, they are linked using an algorithm. The two graphs combined result in a cuboid-like grid graph as shown below. For simplicity, a 2x2 tile grid graph is shown instead of the 3x3 example from the gbmap file.  

<img src="../images/mino/2x2_grid_visual.png">
